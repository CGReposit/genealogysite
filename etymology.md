...
In England the name derives from a medieval place-name formed from Old English elements (a personal/ethnic name or topographical element combined with ford, meaning a river crossing). Early spellings recorded in various documents include forms like _Comberford, Quemerford_ and related variants; these reflect regional pronunciation and medieval orthographic instability. Habitational surnames—those taken from the name of a village, manor or small locality—are common in England, and Commerford/Comerford fits that pattern.
